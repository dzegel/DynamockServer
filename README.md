...
- [Dynamock API](#dynamock-api)
  * [PUT `/expectations`](#put---dynamock-path-base--expectations-)
  * [DELETE `/expectations`](#delete---dynamock-path-base--expectations-)
  * [GET `/expectations`](#get---dynamock-path-base--expectations-)
  * [POST `/expectations-suite/store`](#post---dynamock-path-base--expectations-suite-store-)
  * [POST `/expectations-suite/load`](#post---dynamock-path-base--expectations-suite-load-)
